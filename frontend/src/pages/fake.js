...
import { createProduct } from "../../Product/ProductApi";
...
const ProductForm = () => {
  ...
  const products = useSelector(setSelectedProduct);
  ...
  useEffect(() => {
    if (products && params.id) {
      ...
      setValue("image1", products.images[0]);
      setValue("image2", products.images[1]);
      setValue("image3", products.images[2]);
      setValue("brand", products.brand);
      setValue("category", products.category);
    }
  }, [products, setValue, params.id]);
    ...
    <div>
      <form
        ...
        onSubmit={handleSubmit((data) => {
          ...
          if (params.id) {
            product.rating = products.rating || 3.9;
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              {selectedProduct && selectedProduct.deleted && (
                <h2 className="text-red-500 flex sm:col-span-6">
              ...
              <div className="sm:col-span-6">
                <label
                  htmlFor="title"
                  className=" text-sm flex font-medium leading-6 text-gray-900"
                >
                  Product Name
                </label>
                <div className="mt-2">
              ...
              <div className="col-span-full">
                ...
                <p className="mt-3 flex text-sm leading-6 text-gray-600">
