...
import { clearError, loginUserAsync, selectError } from "./AuthSlice";
          ...
          >
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                />
                {errors.password && (
                  <p className="text-red-500 flex">{errors.password.message}</p>
                )}
                {error && (
                  <p className="text-red-500 flex">
                    {error ? "email or password is not valid try again!" : null}
                  </p>
                )}
              </div>
            </div>
